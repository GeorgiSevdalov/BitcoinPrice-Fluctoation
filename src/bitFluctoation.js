...
function bitFluct(value) {
    console.log(value);
    var _seven = 7; //declarate it like const because need 7 days period.
    var priceStorage = [];
    var sum = 0;
    ...
    for (var _i = 0, priceStorage_1 = priceStorage; _i < priceStorage_1.length; _i++) {
        var el = priceStorage_1[_i];
        sum += el;
    }
    var averageValue = sum / priceStorage.length;
    //////////////////////////////////////////////////////////////////
    var weekAverageStorage = [];
    // used for calculating months
    var mounthAverageStorage = [];
    /**
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, (0, getData_1.getCoinPrice)()];
            case 1:
                coinPrice = _a.sent();
                bitFluct(coinPrice);
                return [3 /*break*/, 3];
